...
return (
        <div className="flex flex-col items-center justify-around border border-gray-200 rounded-2xl m-2 py-20 max-w-5xl w-full mx-auto mt-12">
            <h2 className="md:text-4xl/14 text-2xl font-bold bg-linear-to-r from-primary to-accent text-transparent bg-clip-text">Transform AI-generated text into natural, human writing</h2>
            <p className="mt-4 text-slate-500 max-w-xl text-center">Turn robotic text into clear, engaging, and easy-to-read content in seconds</p>
            <div className="flex items-center gap-4 mt-6 text-sm">
                <button type="button" className="bg-primary hover:bg-primary/90 transition-all cursor-pointer px-8 py-3 text-white font-medium rounded-full active:scale-95">
                    Humanize Text
                </button>
